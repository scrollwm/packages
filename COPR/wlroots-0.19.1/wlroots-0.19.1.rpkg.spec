...
# This package is pinned to wlroots 0.19.1 for scenefx-0.4 and scrollfx compatibility

%global abi_ver 0.19
%global pinned_version 0.19.1
...
Version:        0.19.1
Release:        1%{?dist}
Summary:        A modular Wayland compositor library (pinned to 0.19.1)
...
%description
Pinned version of wlroots 0.19.1 for scenefx-0.4 and scrollfx compatibility.
This package provides a stable wlroots 0.19.1 that will not auto-update.
...
%changelog
* Mon Oct 28 2025 ScrollWM Team <maintainers@scrollwm.org> - 0.19.1-1
- Initial pinned package for ScrollWM
- Pinned to wlroots 0.19.1 for scenefx and scrollfx compatibility
